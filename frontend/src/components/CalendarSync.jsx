  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-8 animate-fade-in text-gray-800">
      ...
      {upcomingSyncedEvents.length > 0 && (
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 shadow-sm animate-fade-in">
          <div className="flex items-center gap-2 mb-4">
            <AlertCircle className="w-5 h-5 text-blue-700" />
            <h2 className="text-lg font-bold text-blue-900">Upcoming Synced Deadlines (Next 7 Days)</h2>
          </div>
